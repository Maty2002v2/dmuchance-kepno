  ...
  <div class="flex items-center space-x-4">
    ...
    <div class="relative w-full max-w-[106px] sm:max-w-[159px]">
      <button
        ...
        @blur="toggleDropdown"
      >
        <!-- <img :src="require(`@/assets/img/${exchangeSelected.img}`)" alt="" class="flex-shrink-0 w-6 h-6 rounded-full" /> -->
        <img src="@/assets/img/country-icon/eng.png" alt="" class="flex-shrink-0 w-6 h-6 rounded-full" />
        ...
        >
          ...
          >
            <div class="flex items-center">
              <img :src="require(`@/assets/img/${exchange.img}`)" alt="" class="flex-shrink-0 w-6 h-6 rounded-full" />
              <span class="block ml-3 font-normal truncate"> {{ exchange.name }} </span>
            </div>
          </li>
        </ul>
      </transition>
